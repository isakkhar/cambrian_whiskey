...
class MakePaymentForm(forms.Form):
  ...
  expiry_month = forms.ChoiceField(label='', choices=MONTH_CHOICES, widget=forms.TextInput(attrs={'placeholder': 'Expiry Month'}), required=False)
  expiry_year = forms.ChoiceField(label='', choices=YEAR_CHOICES, widget=forms.TextInput(attrs={'placeholder': 'Expiry Year'}), required=False)
